...
c<-require(bob)
#the library() function through an error in the output
#library throws an error to the console as does require but
#require also returns a logical value in this case b has taken
